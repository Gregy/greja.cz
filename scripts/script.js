...
$(document).ready(function() {
  var fixLinearGradient = function() {
    var headerstart= $(".row").offset().left;
    var headerend = headerstart + $(".row").outerWidth();
    var gradient = "linear-gradient(to right, #e3e3e2, #ffffff "+headerstart+"px, #ffffff "+headerend+"px, #e3e3e2)";
    //console.log('setting-gradient:', gradient);
    $("html").css("background-image",gradient);
  }
  $(window).resize(fixLinearGradient);
  ...
  //missing last-child support in ie8
